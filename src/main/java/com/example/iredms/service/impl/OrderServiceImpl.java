...
public class OrderServiceImpl implements OrderService {
    ...
    public List<OrderViewDTO> queryOrderList(OrderQueryDTO orderQueryDTO) {
        ...
        if (orderQueryDTO.getOrderName() != null && !orderQueryDTO.getOrderName().isEmpty()) {
            queryRequestVo.addCondition("orderName", ConditionType.LIKE,orderQueryDTO.getOrderName());
        }
